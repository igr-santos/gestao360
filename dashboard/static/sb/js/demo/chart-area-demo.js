...
console.log("labels", chartElement.dataset.chartLabels)
const labels = JSON.parse(chartElement.dataset.chartLabels)
console.log("values", chartElement.dataset.chartValues)
